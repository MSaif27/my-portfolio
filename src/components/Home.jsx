        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          >
            ...
            >
              ...
              I aim to solve real-world problems with smart and practical solutions,
              I continuously work on improving my skills by building projects and
              exploring new technologies in the field of AI.
            </motion.p>
                ...
                {[
                  {
                    icon: FiGithub,
                    color: "text-gray-600",
                    link: "https://github.com/MSaif27",
                  },
                  {
                    icon: FiLinkedin,
                    color: "text-blue-600",
                    link: "https://www.linkedin.com/in/mohd-saif27",
                  },
                  {
                    icon: FiMail,
                    color: "text-cyan-600",
                    link: "mailto:saif905044@gmail.com",
                  },
                ].map((item, i) => (
                  <motion.a
                    key={i}
              ...
              <div className="font-mono text-sm space-y-4">
                ...
                <div className="ml-8">
                  <p className="text-gray-700">
                    ...
                    <span className="text-green-600">"Mohd Saif"</span>,
                  </p>
                  <p className="text-gray-700">
                    <span className="text-blue-600">skills/Feild:</span>{" "}
                    <span className="text-yellow-600">
                      ["Machine Learning","java", "Python", "AI"]
                    </span>
                    ,
                  </p>
                  <p className="text-gray-700">
